...
public class ppListAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public interface OnItemListener {
        void onItemClickpp(int i);
    }

    public ppListAdapter(ArrayList<String> mitemnames, ArrayList<String> mimages, Context mcontext, OnItemListener onItemListener2) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView, OnItemListener onItemListener2) {
            ...
            String unused = ppListAdapter.this.str = this.txt.getText().toString();
        ...
        public void onClick(View v) {
            this.onItemListener.onItemClickpp(getLayoutPosition());
        }
    }
}
