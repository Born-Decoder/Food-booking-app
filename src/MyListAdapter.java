...
public class MyListAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public MyListAdapter(ArrayList<String> mitemnames, ArrayList<String> mimages, Context mcontext, OnItemListener onItemListener2) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView, OnItemListener onItemListener2) {
            ...
            String unused = MyListAdapter.this.str = this.txt.getText().toString();
        ...
        public void onClick(View v) {
            this.onItemListener.onItemClicktop(getLayoutPosition());
        }
    }
}
