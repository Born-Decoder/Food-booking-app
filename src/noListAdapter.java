...
public class noListAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public interface OnItemListener {
        void onItemClickno(int i);
    }

    public noListAdapter(ArrayList<String> mitemnames, ArrayList<String> mimages, Context mcontext, OnItemListener onItemListener2) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(C0563R.layout.hlist_item, parent, false), this.onItemListener);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView, OnItemListener onItemListener2) {
            ...
            String unused = noListAdapter.this.str = this.txt.getText().toString();
        ...
        public void onClick(View v) {
            this.onItemListener.onItemClickno(getLayoutPosition());
        }
    }
}
