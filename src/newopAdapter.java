...
public class newopAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public interface OnItemListener {
        void onItemClicknop(int i);
    }

    public newopAdapter(ArrayList<String> mitemnames, ArrayList<String> mimages, Context mcontext, OnItemListener onItemListener2) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView, OnItemListener onItemListener2) {
            ...
            String unused = newopAdapter.this.str = this.txt.getText().toString();
        ...
        public void onClick(View v) {
            this.onItemListener.onItemClicknop(getLayoutPosition());
        }
    }
}
